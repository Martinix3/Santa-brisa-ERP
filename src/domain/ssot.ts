...
export interface OnHandView {
  ...
  itemId: string;
  sku?: string;         // Para compatibilidad
  lotNumber?: LotNumber;
  lotNumbers?: LotNumber[]; // Para compatibilidad
  locationId?: string;
  warehouseId?: string; // Para compatibilidad
  qty: number;
  reserved?: number;    // Para compatibilidad
  uom: Uom;
  qcStatus?: QcStatus;  // Para compatibilidad
  category?: ItemCategory; // Para compatibilidad
...
// -----------------------------------------------------------------
// 9. Type Aliases for Backward Compatibility
// -----------------------------------------------------------------
...
export type Order = OrderSellOut;
export type OnHand = OnHandView;
