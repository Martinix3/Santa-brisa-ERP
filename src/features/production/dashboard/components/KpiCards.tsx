...
import { KPI } from '@/features/production/components/ui';
...
export function KpiCards({ kpis }: { kpis: any }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <KPI icon={BarChart} label="Rendimiento Medio (30d)" value={`${kpis.avgYield30.toFixed(1)}%`} color="#8b5cf6" />
        <KPI icon={Droplets} label="Coste/Botella Medio (30d)" value={`${kpis.avgCostBottle30.toFixed(3)} €`} color="#db2777" />
