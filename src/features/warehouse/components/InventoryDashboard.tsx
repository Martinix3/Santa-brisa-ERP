...
export function InventoryDashboard({ summaries, uomIncidents = 0 }: Props) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
      <SBCard title="" className="sb-glass">
      ...
      <SBCard title="" className="sb-glass">
        <div className="p-4 space-y-2">
          <p className="text-xs text-zinc-500 uppercase tracking-wide">Incidencias UoM</p>
          <p className="text-3xl font-bold text-zinc-900">{uomIncidents}</p>
          <p className="text-xs text-muted-foreground">Lotes con unidad distinta al maestro del producto.</p>
        </div>
      </SBCard>
    </div>
  );
