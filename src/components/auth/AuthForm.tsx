...
import { SB_THEME } from "@/domain/SB_COLORS";
    ...
    return (
        <div className="h-screen w-screen flex items-center justify-center bg-zinc-50 p-4">
            <div className="w-full max-w-sm text-center p-8 bg-white shadow-xl rounded-2xl border">
                ...
                <form onSubmit={handleSubmit} autoComplete="on" className="space-y-4 text-left">
                    <div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full px-6 py-3 bg-zinc-800 text-white font-semibold rounded-lg hover:bg-zinc-700 transition-colors disabled:bg-zinc-400 sb-btn-primary"
                    >
                ...
                <button
                    ...
                    className="w-full px-6 py-3 bg-yellow-400 text-zinc-900 font-semibold rounded-lg hover:bg-yellow-500 transition-colors flex items-center justify-center gap-2 sb-btn-primary"
                >
                 ...
                 <p className="mt-6 text-sm text-center text-zinc-600">
                    <button onClick={toggleMode} className="font-medium text-yellow-600 hover:underline sb-btn-primary">
                        {toggleButtonText}
                    </button>
                </p>
            </div>
