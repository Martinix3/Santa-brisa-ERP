...
import {
  ...
  Bell, TrendingUp, Monitor, ClipboardCheck, Briefcase,
} from "lucide-react";
...
type Item = NavItem; // Alias for compatibility
type NavSection = {
  title: string;
...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    href: "/ventas",
    items: [
      { href: "/ventas/pipeline", label: "Pipeline" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/quality-v2/appcc", label: "APPCC" },
  ...
  },
  {
    ...
    items: [
      { href: "/distributor/distribuidores", label: "Gestión" },
    ],
  },
  {
    title: "Finanzas",
  ...
  },
  {
    ...
    href: "/admin",
    items: [
      { href: "/admin/brain/gemini", label: "🧠 Gemini Intelligence" },
      { href: "/dev/analyzer-panel", label: "Analyzer Panel" },
      { href: "/dev/analyzer-control-panel", label: "Analyzer Control Panel" },
      { href: "/admin/integrations", label: "Integraciones" },
      { href: "/admin/integrations-test", label: "Test Integraciones" },
        ...
        <>
          ...
          >
            ...
            <div className="space-y-0.5 px-1">
              {hoveredSectionData.items.map((item: Item) => (
                <Link
                  key={item.href}
                  href={item.href}
