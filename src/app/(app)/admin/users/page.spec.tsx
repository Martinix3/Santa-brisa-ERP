...
describe('Admin Users - Sorting', () => {
  it('should sort users alphabetically by name', () => {
    ...
    expect(sorted[0].displayName).toBe('Ana Martínez');
    expect(sorted[1].displayName).toBe('Juan Pérez');
    expect(sorted[4].displayName).toBe('Pedro López');
  });

  it('should handle users without names', () => {
    const usersWithoutNames = [
      ...mockUsers,
      { id: '6', name: '', displayName: '', email: 'test@example.com', role: 'admin' as const, active: true }
    ];
    ...
    expect(sorted[0].displayName).toBe('');
  });
});
...
describe('Admin Users - Edge Cases', () => {
  ...
  it('should handle users with default role', () => {
    const usersWithDefaultRole = [
      { id: '1', name: 'Test User', displayName: 'Test User', email: 'test@example.com', role: 'ops' as const, active: true },
    ];
  ...
  it('should handle users with minimal data', () => {
    ...
    expect(minimalUser.displayName).toBe('Minimal User');
