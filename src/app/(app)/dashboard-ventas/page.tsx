...
const KpiCard = ({
  ...
  return (
    <div className="bg-gray-50 p-5 rounded-lg border" style={{ borderColor: SB.border, backgroundColor: SB.surfaces.muted }}>
  ...
  return (
    <div className="p-6" style={{ background: SB.surfaces.page }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="hidden md:flex items-center gap-2">
            <button
              ...
              style={{ background: SB.brand.accent, color: SB.text.primary, border: `1px solid ${SB.border}` }}
        ...
        {/* Tabs (solo visual) */}
        <div className="border-b" style={{ borderColor: SB.border }}>
          <nav className="flex space-x-4">
            <button className="py-2 px-1 text-sm font-medium" style={{ color: SB.text.secondary }}>Semana</button>
            <button className="py-2 px-1 text-sm font-medium border-b-2" style={{ color: SB.text.primary, borderColor: SB.brand.accent }}>Mes</button>
            <button className="py-2 px-1 text-sm font-medium" style={{ color: SB.text.secondary }}>Año</button>
          </nav>
        </div>
