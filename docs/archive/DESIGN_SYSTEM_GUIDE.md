...
**Nota importante:** Los tabs usan `aria-selected="true"` para el tab activo y `aria-selected="false"` para los inactivos. El CSS aplica automáticamente los estilos correctos.
